...
test('log filter match 0', (t) => {
  ...
  const params = testData0['irc_newFilter-req'].params[0];
  const inputLogs = testData0['irc_getLogs-res'].result;
...
test('log filter - match 2', (t) => {
  ...
  const params = testData2['irc_newFilter-req'].params[0];
  const inputLogs = testData2['irc_getLogs-res'].result;
...
test('log filter - match case-sensitive', (t) => {
  ...
  const params = testData3['irc_newFilter-req'].params[0];
  const inputLogs = testData3['irc_getLogs-res'].result;
